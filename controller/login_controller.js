...
// Database connection-
var db = require('../helper/d_base.js');
var conn = new db.Connection();

// authentication helper
var auth_help = require('../helper/auth_helper.js')
var auth_helper = new auth_help.auth_helper();
...
LoginController.prototype.handle = function(restUrl,res,config,session_id,sessMgmt){
    ...
    if (restUrl.id == "login"){
        ...
        if (restUrl.params.new_user !== undefined) {
            ...
            // save the registration and send the confirmation email
            var auth_key = auth_helper.getAuthKey();
            ...
            conn.registerUser(user_obj, function () {
                ...
                fs.readFile(mailTemplateFile, function(err, filedata){
                    if (err === null ){
                        ...
                        var mail_subject = "Confirmation for MyJourney";
        ...
        conn.confirmUser(user_data, function () {
            ...
            // Success
            var data = {
                title: "MyJourney confirmation successful"
            };
            ...
            var data = {
                title: "MyJourney Confirmation not successful",
                success: 0
            };
        ...
        conn.performLogin(login_data, function (user_) {
            ...
            var data = {
                title: "MyJourney Login successful",
                success: 1
            };
            ...
            var data = {
                title: "MyJourney Login not successful",
                success: 0
            };
        ...
        var data = {
            title: "MyJourney Logout successful",
            success: 1
        };
